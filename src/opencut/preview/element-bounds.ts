...
import { STICKER_INTRINSIC_SIZE_FALLBACK } from "@oc/stickers/intrinsic-size";
import { DEFAULT_GRAPHIC_SOURCE_SIZE } from "@oc/graphics";
import { measureTextElement } from "@oc/text/measure-element";
import {
	getElementLocalTime,
} from "@oc/animation";
import { resolveTransformAtTime } from "@oc/rendering/animation-values";
import { buildTransformFromParams } from "@oc/rendering";
