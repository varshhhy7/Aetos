...
import type { ElementBounds } from "@oc/preview/element-bounds";
...
import { calculateTotalDuration } from "@oc/timeline";
import { TimelineDragSource } from "@oc/timeline/drag-source";
import { findTrackInSceneTracks } from "@oc/timeline/track-element-update";
import { lastFrameMediaTime, type MediaTime, ZERO_MEDIA_TIME } from "@oc/wasm";
import {
	canElementBeHidden,
	canElementHaveAudio,
} from "@oc/timeline/element-utils";
import { isElementMuted } from "@oc/timeline/audio-state";
import type {
	AnimationPath,
...
} from "@oc/commands/timeline";
import type { InsertElementParams } from "@oc/commands/timeline/element/insert-element";
import type {
	PlannedElementMove,
	PlannedTrackCreation,
} from "@oc/timeline/group-move";
