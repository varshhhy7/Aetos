...
import { clampRetimeRate, shouldMaintainPitch } from "@oc/retime/rate";
import type { AudioClipSource } from "@oc/media/audio";
import { createAudioContext, collectAudioClips } from "@oc/media/audio";
import {
	buildAudioGainAutomation,
	hasAnimatedVolume,
} from "@oc/timeline/audio-state";
import { createAudioMasteringChain } from "@oc/media/audio-mastering";
import {
