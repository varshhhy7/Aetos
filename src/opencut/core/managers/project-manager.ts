...
import type {
	...
	TProjectSettings,
	TTimelineViewState,
} from "@oc/project/types";
import type { ExportOptions, ExportResult, ExportState } from "@oc/export";
import { storageService } from "@oc/services/storage/service";
import { toast } from "sonner";
import { generateUUID } from "@oc/utils/id";
import { UpdateProjectSettingsCommand } from "@oc/commands/project";
import { DEFAULT_BACKGROUND_COLOR } from "@oc/background/color";
import { DEFAULT_CANVAS_SIZE } from "@oc/canvas/sizes";
import { DEFAULT_FPS } from "@oc/fps/defaults";
import { buildDefaultScene, getProjectDurationFromScenes } from "@oc/timeline/scenes";
import { buildScene } from "@oc/services/renderer/scene-builder";
import { CanvasRenderer } from "@oc/services/renderer/canvas-renderer";
import {
	CURRENT_PROJECT_VERSION,
	migrations,
	runStorageMigrations,
	type MigrationProgress,
} from "@oc/services/storage/migrations";
import { loadFonts } from "@oc/fonts/google-fonts";
import { DEFAULTS } from "@oc/timeline/defaults";
import { getElementFontFamilies } from "@oc/timeline/element-utils";
import { getRaisedProjectFpsForImportedMedia } from "@oc/fps/utils";
