...
import { shouldMaintainPitch } from "@oc/retime/rate";
import type { MediaAsset } from "@oc/media/types";
import { applyAudioMasteringToBuffer } from "@oc/media/audio-mastering";
import type { AudioCapableElement } from "@oc/timeline/audio-state";
import {
	hasAnimatedVolume,
	isElementMuted,
	resolveEffectiveAudioGain,
} from "@oc/timeline/audio-state";
import { doesElementHaveEnabledAudio } from "@oc/timeline/audio-separation";
import { canElementHaveAudio, hasMediaId } from "@oc/timeline/element-utils";
import { canTrackHaveAudio } from "@oc/timeline";
import { mediaSupportsAudio } from "@oc/media/media-utils";
import { getSourceTimeAtClipTime, renderRetimedBuffer } from "@oc/retime";
import { Input, ALL_FORMATS, BlobSource, AudioBufferSink } from "mediabunny";
import { TICKS_PER_SECOND } from "@oc/wasm";
import {
	computeRmsBuckets,
	type SampleBucket,
} from "@oc/media/waveform-summary";
