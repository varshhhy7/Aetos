...
import { TIMELINE_DRAG_THRESHOLD_PX } from "@oc/timeline/components/interaction";
import { getMouseTimeFromClientX } from "@oc/timeline/drag-utils";
import {
	buildTimelineSnapPoints,
	getTimelineSnapThresholdInTicks,
	resolveTimelineSnap,
	type SnapPoint,
} from "@oc/timeline/snapping";
import { getBookmarkSnapPoints } from "../snap-source";
import { getElementEdgeSnapPoints } from "@oc/timeline/element-snap-source";
import { getPlayheadSnapPoints } from "@oc/timeline/playhead-snap-source";
import { getAnimationKeyframeSnapPointsForTimeline } from "@oc/timeline/animation-snap-points";
import type { Bookmark } from "@oc/timeline";
import { roundFrameTime, type MediaTime, ZERO_MEDIA_TIME } from "@oc/wasm";
