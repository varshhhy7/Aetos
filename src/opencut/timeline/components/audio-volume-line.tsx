...
import {
	getDbFromLinePos,
	getLinePosFromDb,
} from "@oc/timeline/audio-display";
import { VOLUME_DB_MAX, VOLUME_DB_MIN } from "@oc/timeline/audio-constants";
import { getElementVolume, hasAnimatedVolume } from "@oc/timeline/audio-state";
import type { AudioElement } from "@oc/timeline/types";
import {
	clamp,
