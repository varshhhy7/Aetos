...
import { useAssetsPanelStore } from "@oc/components/editor/panels/assets/assets-panel-store";
import { AudioWaveform, WAVEFORM_GAIN_SAMPLE_COUNT } from "./audio-waveform";
import { AudioVolumeLine } from "./audio-volume-line";
import { useElementPreview } from "@oc/timeline/hooks/use-element-preview";
import {
	useKeyframeDrag,
	type KeyframeDragState,
} from "@oc/timeline/hooks/element/use-keyframe-drag";
import { useKeyframeSelection } from "@oc/timeline/hooks/element/use-keyframe-selection";
import { useKeyframeBoxSelect } from "@oc/timeline/hooks/element/use-keyframe-box-select";
import { SelectionBox } from "@oc/selection/selection-box";
import { getElementKeyframes } from "@oc/animation";
import {
	canElementHaveAudio,
	canElementBeHidden,
	hasElementEffects,
...
import type { SelectionBoxBounds } from "@oc/selection/types";
import type {
...
import { mediaSupportsAudio } from "@oc/media/media-utils";
import {
	canToggleSourceAudio,
	getSourceAudioActionLabel,
	isSourceAudioSeparated,
} from "@oc/timeline/audio-separation";
import { buildWaveformGainSamples, isElementMuted } from "@oc/timeline/audio-state";
import { getTimelinePixelsPerSecond } from "@oc/timeline";
import { buildWaveformSourceKey } from "@oc/media/waveform-summary";
import { addMediaTime, type MediaTime, TICKS_PER_SECOND } from "@oc/wasm";
import {
	getActionDefinition,
	type TAction,
...
import { resolveStickerId } from "@oc/stickers";
import { buildGraphicPreviewUrl } from "@oc/graphics";
...
import { uppercase } from "@oc/utils/string";
import { useMemo, type ComponentProps, type ReactNode } from "react";
import type { SelectedKeyframeRef, ElementKeyframe } from "@oc/animation/types";
import { cn } from "@oc/utils/ui";
import { usePropertiesStore } from "@oc/components/editor/panels/properties/stores/properties-store";
import { getTrackTypeForElementType } from "@oc/timeline/placement/compatibility";
