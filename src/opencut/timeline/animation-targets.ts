...
} from "@oc/animation/effect-param-channel";
import {
	parseGraphicParamPath,
} from "@oc/animation/graphic-param-channel";
import { effectsRegistry, registerDefaultEffects } from "@oc/effects";
import { getGraphicDefinition } from "@oc/graphics";
import {
	coerceParamValue,
