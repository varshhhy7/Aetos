import type { ParamDefinition } from "@oc/params";
import type {
	MaskDefinition,
	MaskParamUpdateArgs,
	TextMask,
...
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from "@oc/text/typography";
import {
	drawMeasuredTextLayout,
	measureTextLayout,
	strokeMeasuredTextLayout,
} from "@oc/text/primitives";
import { getTextMeasurementContext } from "@oc/text/measure-element";
import { getTextVisualRect } from "@oc/text/layout";
import {
	getBoxMaskHandlePositions,
	getBoxMaskRectOverlay,
} from "@oc/masks/handle-positions";
import { computeFeatherUpdate } from "@oc/masks/param-update";
import {
	setMaskLocalCenter,
	toGlobalMaskSnapLines,
} from "@oc/masks/geometry";
import {
	snapPosition,
	snapRotation,
	snapScale,
