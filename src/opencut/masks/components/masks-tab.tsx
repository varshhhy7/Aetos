...
import type { MaskableElement } from "@oc/timeline";
import type { Mask, MaskType, TextMask } from "@oc/masks/types";
import type { NumberParamDefinition, SelectParamDefinition } from "@oc/params";
import {
...
import { useMenuPreview } from "@oc/editor/use-menu-preview";
import { getVisibleElementsWithBounds } from "@oc/preview/element-bounds";
...
import { ColorPicker } from "@oc/components/ui/color-picker";
import { FontPicker } from "@oc/components/ui/font-picker";
import {
	DropdownMenu,
	DropdownMenuContent,
	DropdownMenuItem,
	DropdownMenuTrigger,
} from "@oc/components/ui/dropdown-menu";
import { NumberField } from "@oc/components/ui/number-field";
import {
	Select,
	SelectContent,
	SelectItem,
	SelectTrigger,
	SelectValue,
} from "@oc/components/ui/select";
import { Textarea } from "@oc/components/ui/textarea";
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from "@oc/components/ui/tooltip";
import {
	clamp,
...
import { usePropertyDraft } from "@oc/components/editor/panels/properties/hooks/use-property-draft";
import {
	OcMirrorIcon,
	OcShapesIcon,
	OcTextHeightIcon,
	OcTextWidthIcon,
} from "@oc/components/icons";
