...
import { getMaskDefinition } from "@oc/masks";
import { appendPointToFreeformPathMask } from "@oc/masks/freeform/definition";
import {
	getVisibleElementsWithBounds,
	type ElementBounds,
} from "@oc/preview/element-bounds";
import {
	SNAP_THRESHOLD_SCREEN_PIXELS,
	type SnapLine,
} from "@oc/preview/preview-snap";
import type { SelectedMaskPointSelection } from "@oc/selection/editor-selection";
import type { Mask, MaskHandleId, MaskInteractionResult } from "@oc/masks/types";
import type { MaskableElement } from "@oc/timeline";
import { isMaskableElement } from "@oc/timeline/element-utils";
