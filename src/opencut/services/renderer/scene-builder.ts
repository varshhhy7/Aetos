import type { SceneTracks, TimelineTrack } from "@oc/timeline";
...
import type { TBackground, TCanvasSize } from "@oc/project/types";
import { DEFAULT_BACKGROUND_BLUR_INTENSITY } from "@oc/background/blur";
import {
