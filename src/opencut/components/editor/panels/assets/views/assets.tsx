...
import { MediaDragOverlay } from "@oc/components/editor/panels/assets/drag-overlay";
...
import { DEFAULT_NEW_ELEMENT_DURATION } from "@oc/timeline/creation";
import { mediaTimeFromSeconds, type MediaTime } from "@oc/wasm";
import { useEditor } from "@oc/editor/use-editor";
import { useFileUpload } from "@oc/media/use-file-upload";
import { invokeAction } from "@oc/actions";
import { processMediaAssets } from "@oc/media/processing";
import { showMediaUploadToast } from "@oc/media/upload-toast";
import {
	SelectableItem,
	SelectableSurface,
	useSelection,
...
import { buildElementFromMedia } from "@oc/timeline/element-utils";
import {
	type MediaSortKey,
	type MediaSortOrder,
	type MediaViewMode,
	useAssetsPanelStore,
} from "@oc/components/editor/panels/assets/assets-panel-store";
import { MASKABLE_ELEMENT_TYPES } from "@oc/timeline";
